...
<>
  <div className="flex justify-center items-center min-h-screen bg-gray-300">
    <div className="bg-white shadow-lg rounded-2xl p-8 md:p-12 w-full sm:w-3/4 md:w-2/3 lg:w-1/2 flex items-center space-x-6">
      <img
      ...
      />
      <div>
        <h1 className="title-font text-2xl font-medium text-black">
