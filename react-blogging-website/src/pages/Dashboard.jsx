    ...
    <>
      <div className="bg-blue-50 h-[full]">
        <div className="bg-white text-black navbar justify-between">
          <h1 className="font-bold text-4xl m-3">Dashboard</h1>
          <Link to="/">
          ...
          <form onSubmit={handleSubmit(sendDatafirestore)}>
            <div className="m-4">
              <textarea
                ...
                className="textarea textarea-xs textarea-bordered w-full bg-slate-200 hover:bg-blue-200"
              ></textarea>
            </div>
            <div className="m-4">
              <textarea
                ...
                className="textarea textarea-bordered w-full bg-slate-200 hover:bg-blue-200"
              ></textarea>
            </div>
